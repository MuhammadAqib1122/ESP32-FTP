class ESP32_FTPClient_updated
{
  ...
  WiFiClient dclient;
  char outBuf[128];
  ESP32_FTPClient_updated(char* _serverAdress, uint16_t _port, char* _userName, char* _passWord, uint16_t _timeout = 10000, uint8_t _verbose = 1);
  ESP32_FTPClient_updated(char* _serverAdress, char* _userName, char* _passWord, uint16_t _timeout = 10000, uint8_t _verbose = 1);
  void OpenConnection();
